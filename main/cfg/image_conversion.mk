...
## Transition Image
PALETTE_BETWEEN=0 6 13 26
$(eval $(call IMG2SP, SET_MODE,			1))
$(eval $(call IMG2SP, SET_PALETTE_FW,		$(PALETTE_BETWEEN)))
$(eval $(call IMG2SP, SET_OUTPUT,		bin))
$(eval $(call IMG2SP, SET_IMG_FORMAT,		screen))
$(eval $(call IMG2SP, SET_FOLDER,		tmp/))
#$(eval $(call IMG2SP, CONVERT,			img/between.png, 0, 0, between,,))
#$(eval $(call IMG2SP, CONVERT_PALETTE,	$(PALETTE_MENU), m_palette))

## GUI & FRAME
PALETTE_GUI=0 3 6 25
$(eval $(call IMG2SP, SET_MODE,			1))
$(eval $(call IMG2SP, SET_PALETTE_FW,		$(PALETTE_GUI)))
$(eval $(call IMG2SP, SET_OUTPUT,		bin))
$(eval $(call IMG2SP, SET_IMG_FORMAT,		screen))
$(eval $(call IMG2SP, SET_FOLDER,		tmp/))
#$(eval $(call IMG2SP, CONVERT,			img/gui.png, 0, 0, gui,,))
#$(eval $(call IMG2SP, CONVERT,			img/frame.png, 0, 0, frame,,))
#$(eval $(call IMG2SP, CONVERT_PALETTE,	$(PALETTE_GUI), g_palette))


## Logo Image
PALETTE_LOGO=0 3 6 26
$(eval $(call IMG2SP, SET_MODE,			1))
$(eval $(call IMG2SP, SET_PALETTE_FW,		$(PALETTE_LOGO)))
$(eval $(call IMG2SP, SET_OUTPUT,		c))
$(eval $(call IMG2SP, SET_IMG_FORMAT,		sprites))
$(eval $(call IMG2SP, SET_FOLDER,		tmp/))
#$(eval $(call IMG2SP, CONVERT,			img/logo.png, 100, 26, logo,,))

## Convert fonts to tileset
PALETTE_FONT={0 3 6 26}
#$(eval $(call IMG2SPRITES,img/font.png,1,font_ts,8,8,$(PALETTE_FONT),tileset,out/))

## Handle tiles
PALETTE_TILES={0 3 6 15}
#$(eval $(call IMG2SPRITES,img/masked16x16nsew.png,1,tile_m_16x16,16,16,$(PALETTE_TILES),tileset,out/))
#$(eval $(call IMG2SPRITES,img/regina16x16nsew.png,1,regina_m_16x16,16,16,$(PALETTE_TILES),tileset,out/))
...
#$(eval $(call IMG2SPRITES,img/map8x8.png,1,mapm8,8,8,$(PALETTE_TILES),tileset,out/))
